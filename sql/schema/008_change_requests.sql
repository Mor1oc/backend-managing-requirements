...
CREATE TABLE change_requests (
    ...
    status_id UUID NOT NULL REFERENCES change_request_statuses(status_id) ON DELETE RESTRICT,
    priority_id UUID NOT NULL REFERENCES change_request_priorities(priority_id) ON DELETE RESTRICT,
...
CREATE TABLE change_request_requirements (
    ...
    PRIMARY KEY (ecr_id, requirement_id, version_number),
    FOREIGN KEY (ecr_id)
        REFERENCES change_requests(ecr_id)
        ON DELETE CASCADE,
